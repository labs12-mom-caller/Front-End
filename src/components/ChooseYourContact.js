...
import { Container, Section, Img, H2, Info } from '../styles/Scheduler/index';
import chooseContact from '../assets/svg/undrawChooseContact.svg';
    ...
    <Container>
      <Section>
        <Info>
          ...
          Please enter your loved one&apos;s information to schedule a call.
        </Info>
        <Info>
        ...
        <Img
          className='choose-contact-img'
          src={chooseContact}
          alt='Woman looking at contacts'
        />
      </Section>
      <Wrapper>
        <Header>
          <H2 className='contact-header'>Choose Your Contact</H2>
        </Header>
        <Formik
          initialValues={{
            email: '',
